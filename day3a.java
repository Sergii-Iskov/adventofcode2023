...
/**
 * This task "Day 3: Gear Ratios" is from https://adventofcode.com/2023/day/3
 * We need to calculate the sum of all of the part numbers in the engine schematic.
...
public class day3a {
    ...
    public static void main(String[] args) {
                        ...
                        for (int y = -1; y < 2; y++) {
                            if (checkInBorder(logicArr, col + x, row + y) && !logicArr[row + y][col + x]) {
                                ...
                                if (Character.isDigit(currentCh)) {
                                    ...
                                    engineNumber += Integer.parseInt(newNumber);
                                }
                            }
                        }
                    }
        ...
        System.out.println("Total count = " + engineNumber);
    }
