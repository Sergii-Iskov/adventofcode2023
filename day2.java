 ...
 * We need to calculate the sum of the IDs of possible games.
        ...
        for (int i = 0; i < gameArray.length; i++) {
            ...
            for (int j = 0; j < game.length; j++) {
                ...
                for (int k = 0; k < sets.length; k++) {
                    ...
                    if ((Objects.equals(set[1], "red") && Integer.parseInt(set[0]) > RED)
                           || (Objects.equals(set[1], "green") && Integer.parseInt(set[0]) > GREEN)
                           || (Objects.equals(set[1], "blue") && Integer.parseInt(set[0]) > BLUE)) {
                        point = false;
                    }
                }
