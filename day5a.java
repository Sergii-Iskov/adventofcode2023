...
/**
 * This task "Day 5: If You Give A Seed A Fertilizer" is from https://adventofcode.com/2023/day/5
...
public class day5a {
    public static void main(String[] args) {
        ...
        long [] locationArray = new long[seedsArray.length];
        long minLocation = -1;
        for (int i = 0; i < locationArray.length; i++) {
            long seed = Long.parseLong(seedsArray[i]);

            long soil = findValue(seed, seedToSoilMap);
