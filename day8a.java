...
public class day8a {
    public static void main(String[] args) {
        ...
        int road = findRoad("AAA", dataMap);
        System.out.println("\n" + road);
        System.out.println("instruction end = " + instruction.length());

    }

    // Method for calculation min steps from "AAA" to "ZZZ"
    private static int findRoad(String s, HashMap<String, String[]> map) {
        ...
        for (int i = 0; i < instruction.length(); i++) {
            ...
            System.out.print(currentPosition + " - ");
            if (currentPosition.equals("ZZZ")) return step;
